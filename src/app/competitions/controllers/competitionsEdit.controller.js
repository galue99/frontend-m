...
(function() {
  ...
  angular
    .module('charter')
    .controller('CompetitionEditController', CompetitionEditController);

  /** @ngInject */
  function CompetitionEditController($scope, $uibModalInstance, competition, competitionsService) {
